...
SCENARIOS = [
    {
        "scenario_id": 6,
        "descripcion": "Fuga central, caudal grande (Fácil)",
        "x_leak_true": 4000,
        "q_leak_true": 0.030,
        "dificultad": "FÁCIL",
    }
...
if __name__ == '__main__':
    ...
    print("  ═══════════════════════════════════════════════")
    print("Corriendo quick test en 1 escenario (Prueba Rápida de Perfect Physics)...")

    results = []
    for i, scenario in enumerate(SCENARIOS):
        print(f"[{i+1}/1] Escenario {scenario['scenario_id']} | x_leak={scenario['x_leak_true']}m | q={scenario['q_leak_true']} | dificultad={scenario['dificultad']}")
