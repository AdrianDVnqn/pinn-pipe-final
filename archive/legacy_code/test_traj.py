...
def train_test(sim):
    ...
    # We will just run 5000 epochs with sig=100
    opt = torch.optim.Adam([
        {'params': model.network_params(), 'lr': minimal.LR_NET},
        {'params': [model.x_leak_raw], 'lr': minimal.LR_XLEAK}
    ])
    ...
    for epoch in range(1, 4001):
        ...
        # Anneal from 200 down to 100
        sig = 200.0 - 100.0 * (epoch / 4000.0)
